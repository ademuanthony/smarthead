...
import (
	...
	"remoteschool/smarthead/cmd/web-api/docs"
	"remoteschool/smarthead/cmd/web-api/handlers"
...
func main() {
	...
	var cfg struct {
		...
		Project struct {
			...
			WebAppBaseUrl     string `default:"http://www.smarthead.com.ng" envconfig:"WEB_APP_BASE_URL" example:"www.example.saasstartupkit.com"`
		}
		Redis struct {
