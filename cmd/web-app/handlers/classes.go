...
// Classes represents the Classes API method handler set.
type Classes struct {
...
func urlClassesIndex() string {
	return fmt.Sprintf("/admin/classes")
}

func urlClassesCreate() string {
	return fmt.Sprintf("/admin/classes/create")
}

func urlClassesView(classID string) string {
	return fmt.Sprintf("/admin/classes/%s", classID)
}

func urlClassesUpdate(classID string) string {
	return fmt.Sprintf("/admin/classes/%s/update", classID)
}

// Index handles listing all the classes for the current account.
func (h *Classes) Index(ctx context.Context, w http.ResponseWriter, r *http.Request, params map[string]string) error {
...
func (h *Classes) Create(ctx context.Context, w http.ResponseWriter, r *http.Request, params map[string]string) error {
