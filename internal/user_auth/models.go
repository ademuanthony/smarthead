...
type OAuth2PasswordRequest struct {
	...
	Scope     []string `json:"scope" schema:"scope" validate:"omitempty,dive,oneof=admin user teacher finance student" enums:"admin,user,teacher,finance,student" swaggertype:"array,string" example:"admin"`
