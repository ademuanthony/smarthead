...
func testStudentToManyDeposits(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = a.L.LoadDeposits(ctx, tx, false, (*[]*Student)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testStudentToManySubscriptions(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := StudentSlice{&a}
	if err = a.L.LoadSubscriptions(ctx, tx, false, (*[]*Student)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testStudentToManyAddOpDeposits(t *testing.T) {
	var err error
...
func testStudentToManyAddOpSubscriptions(t *testing.T) {
	var err error
